  ...
  return [
    {
      ...
      content:
        ...
        "Kesin hukum verme; her zaman 'olasi', 'kontrol edilmeli' gibi ihtiyatli dil kullan. Yuklenen gorsel bir ekspertiz raporuna benzemiyorsa (alakasiz fotograf, bos sayfa, okunamayacak kadar bulanik) isReportReadable=false don ve findings=[] birak.",
    },
    {
      role: "user",
      content: [
