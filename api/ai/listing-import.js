...
const BRAND_OPTIONS = [
  "Audi", "BMW", "BYD", "Chery", "Chevrolet", "Citroen", "Cupra", "Dacia", "Fiat", "Ford",
  "Honda", "Hyundai", "Jeep", "Kia", "Lexus", "Mazda", "Mercedes-Benz", "MG", "Mini", "Nissan",
  "Opel", "Peugeot", "Renault", "Seat", "Skoda", "Suzuki", "Tesla", "Toyota", "Volkswagen", "Volvo",
];
const TRIM_OPTIONS = [
  "Baz paket", "Orta paket", "Üst paket", "Business", "Comfort", "Dream", "Dynamic", "Elegance",
  "Executive", "Joy", "Life", "Premium", "Style", "Touch", "Trend", "Belirtilmemiş",
];
const CITY_OPTIONS = [
...
const BODY_TYPES = ["Sedan", "Hatchback", "Station wagon", "SUV", "Crossover", "Coupe", "Cabrio", "MPV", "Pickup", "Panelvan"];
...
const FIELD_NAMES = [
  "brand", "model", "year", "trim", "fuelType", "transmission", "mileage", "price", "city",
  "bodyType", "engineSize", "enginePower", "drivetrain", "ownerInfo", "tradeStatus", "airbagStatus",
  "lpgStatus", "hasHeavyDamage", "hasChassisRepair", "hasSpareKey", "sellerDescription",
];
