...
const requiredFiles = [
  ...
  "docs/market-review-lessons-checklist.md",
  "docs/how-to-test.md",
  ...
  "scripts/check-market-review-lessons.mjs",
  "scripts/check-storekit-release-gate.mjs",
...
const requiredTextChecks = [
  ...
  {
    file: "docs/all-steps-status.md",
    snippets: ["iOS Xcode Build Check", "npm run external:check"],
  },
  {
  ...
  {
    file: "docs/market-review-lessons-checklist.md",
    snippets: [
