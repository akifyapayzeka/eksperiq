  ...
  return (
    <AppShell>
      <div className="max-w-5xl pt-6">
        ...
        <section className="mt-5 grid gap-3 rounded-theme border border-border bg-card p-5 shadow-sm">
          ...
          <div className="grid gap-3 md:grid-cols-2">
            {BUYER_DECISION_GUIDE.map((item) => (
              <article key={item.title} className="rounded-theme-sm border border-border bg-muted p-4">
        ...
        <section className="mt-5 rounded-theme border border-border bg-card p-5 shadow-sm">
          ...
          <div className="mt-4 grid gap-3">
            {purchaseFlow.map((step, index) => {
              ...
              return (
                <article key={step.title} className="rounded-theme-sm border border-border bg-muted p-4">
          ...
          <div className="mt-4 grid gap-3 md:grid-cols-3">
            {serviceDirections.map((item) => (
              <Link
                key={item.title}
                href={item.href}
                className="rounded-theme-sm border border-border bg-muted p-4 hover:border-accent"
              >
                <h3 className="font-semibold text-foreground">{item.title}</h3>
