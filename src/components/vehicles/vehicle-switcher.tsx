      ...
      {mode === "idle" ? (
        <div className="mt-3 flex flex-wrap items-center gap-2">
          ...
          <button
            ...
            className="inline-flex min-h-11 items-center gap-1 rounded-full transition active:scale-95 border border-slate-300 px-3 text-sm font-semibold text-slate-800 hover:border-teal-700"
          >
          ...
          {canDelete ? (
            <button
              ...
              className="inline-flex min-h-11 items-center gap-1 rounded-full transition active:scale-95 border border-red-200 px-3 text-sm font-semibold text-red-700 hover:border-red-400"
            >
        ...
        <div role="alert" className="mt-3 rounded-lg border border-red-200 bg-red-50 p-3">
          ...
          <div className="mt-3 flex flex-wrap gap-2">
            ...
            <button
              ...
              className="inline-flex min-h-11 items-center rounded-full transition active:scale-95 border border-slate-300 px-4 text-sm font-semibold text-slate-800"
            >
              Vazgeç
            </button>
          </div>
        ...
        <div className="mt-3 flex flex-wrap items-center gap-2">
          ...
          <button
            type="button"
            onClick={submitDraft}
            className="inline-flex min-h-11 items-center rounded-full transition active:scale-95 bg-slate-950 px-4 text-sm font-semibold text-white"
          >
