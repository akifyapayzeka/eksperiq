...
- Aynı komut `*-github-issue.md` dosyası da üretir; bu dosya GitHub issue gövdesi için kopyalanabilir başlangıçtır ve issue'a taşınmadan önce kişisel veri açısından tekrar kontrol edilir.
